...
export const PROJECT_NAME = "Action";
...
// colors are meant to be set in variables.scss file
export const COLOR_PRIMARY = styles.primaryColor;
export const COLOR_SECONDARY = styles.secondaryColor;
